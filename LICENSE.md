...
cgrade 0.1.0 is licensed under **LGPL-3.0-only WITH LGPL-3.0-linking-exception**.
...
This is the first release line; there are no previously distributed releases
with retained grants.
