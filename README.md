...
See the [installation guide](https://github.com/corbet-foss/cgrade/blob/main/docs/installation.md)
...
Scale IDs are lowercase; lookups accept mixed-case input. Unknown systems, out-of-range grades, and degenerate scales return `null`/`None`/`none`. Scale bounds come from the KMK Beschluss, anabin, the HSG conversion table, and notenberechner.ch; see [the tables](https://github.com/corbet-foss/cgrade/tree/main/tables).
...
| [cgrade](https://github.com/corbet-foss/cgrade) | School grades and the Bavarian formula |

## Development

Behavior is defined by [the grade tables](https://github.com/corbet-foss/cgrade/tree/main/tables)
and [shared conformance vectors](https://github.com/corbet-foss/cgrade/tree/main/tests/vectors).
...
See [the release guide](https://github.com/corbet-foss/cgrade/blob/main/docs/releasing.md)
...
[WITH LGPL-3.0-linking-exception](https://github.com/corbet-foss/cgrade/blob/main/LICENSES/LGPL-3.0-only%20WITH%20LGPL-3.0-linking-exception.txt),
